...
(instance RoomScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(10
				(localproc_000c 128 30 9 9 (Format @local1 120 0))
				(localproc_000c
					147
					58
					12
					9
					(Format @local1 {Point and Click})
				)
				(= cycles 10)
			)
			(11
				(localproc_000c 146 90 9 9 (Format @local1 120 1))
				(= cycles 10)
			)
			(12
				(localproc_000c 143 110 9 9 (Format @local1 120 2))
				(= cycles 10)
			)
			(13
				(localproc_000c 132 130 9 9 (Format @local1 120 3))
				(= cycles 10)
			)
			(14
				(aThigh setCycle: Fwd)
